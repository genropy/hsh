...
class Table(object):
    def config_db(self, pkg):
        tbl =  pkg.table('oggetto_categoria',pkey='id',
                            ...
                            caption_field='nome', partition_casa_id='casa_id', lookup=True)
        ...
        tbl.column('posto_id',size='22', group='_', name_long='Posto').relation('posto.id', 
                    relation_name='categorie_posti', mode='foreignkey', onDelete='raise')